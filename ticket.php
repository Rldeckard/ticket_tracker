...
<html>
  ...
  <body>
    <div>
      <h1 style="background-color:grey;padding:15px;border-radius:15px 15px 0 0;position:relative;">Ticket#&nbsp;<?php print $_GET['ID']; print '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Summary: '.$_GET['Summary'];?></h1>
      <div style="background-color:lightgray;position:relative;top:-26px;padding-bottom:30px">
        ...
        <h2 style="padding:10px">Comment Added</h2>
<?php
        ...
        if (mysqli_num_rows($data_q) > 0) {
          while ($r = mysqli_fetch_assoc($data_q)) {
            print '<div style="padding-left: 50px;padding-right:50px;overflow-wrap:normal">'.wordwrap($r['description'],200,"<br>")."</div>";
          }
        }
?>
        </div>
