...
<body>
  <div>
    <h1 style="background-color:grey;padding:15px;border-radius:15px 15px 0 0;position:relative;">Ticket#&nbsp;<?php print $_GET['ID']; print 'Summary: <span style="left:200px">'.$_GET['Summary'].'</span>';?></h1>
